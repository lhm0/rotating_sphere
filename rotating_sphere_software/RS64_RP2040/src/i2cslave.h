...
#define MAX_UPLOAD_FRAME_SIZE 80       // Empfang vom Master (z. B. Upload)
#define MAX_DOWNLOAD_FRAME_SIZE 64     // Antwort an Master (limitiert durch Wire)
...
private:
    ...
    static uint8_t rxBuffer[MAX_UPLOAD_FRAME_SIZE];
    static size_t rxPos;
