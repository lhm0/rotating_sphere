...
I2CFileTransfer::I2CFileTransfer(I2CMaster& i2cRef) : i2c(i2cRef) {}
...
void I2CFileTransfer::update() {
    ...
    // === Einfache Befehle: SELECT_IMAGE / SET_TIME / SET_TZ ===
    if (state == State::START_SENT &&
        (mode == Mode::SELECT_IMAGE || mode == Mode::SET_TIME || mode == Mode::SET_TZ)) {
